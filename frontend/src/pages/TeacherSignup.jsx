...
const TeacherSignup = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-green-500 py-8">
      <div className="bg-white p-8 rounded-lg shadow-md max-w-md w-full">
        <h2 className="text-3xl font-bold mb-6 text-center text-green-600">Teacher Signup</h2>
