...
import { Lock, Loader2, ArrowLeft, ShieldCheck, Code2, AlertCircle } from 'lucide-react';
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#111] relative overflow-hidden border-r border-[#222]">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center w-full px-20">
          ...
          <h1 className="text-5xl font-black text-center tracking-tighter text-white mb-6">
            New <br />
            <span className="bg-gradient-to-r from-indigo-400 to-blue-400 bg-clip-text text-transparent italic">Beginnings</span>
          </h1>
          <p className="text-slate-400 text-center text-lg max-w-md leading-relaxed">
            Set a strong, secure password and get back to solving problems on the platform.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8 relative overflow-hidden">
        ...
        >
          <div className="mb-10 text-center lg:text-left">
            <h2 className="text-3xl font-black text-white tracking-tight mb-2">Create New Password</h2>
            <p className="text-slate-400 font-medium">Your new password must be different from previous ones.</p>
          </div>
          ...
          <AnimatePresence>
            {success && (
              <motion.div 
                ...
                animate={{ opacity: 1, scale: 1 }}
                className="bg-emerald-500/10 border border-emerald-500/20 p-6 rounded-xl mb-8 flex flex-col items-center gap-4 text-center"
              >
                <div className="w-12 h-12 bg-emerald-500/20 rounded-full flex items-center justify-center text-emerald-400">
                  <ShieldCheck className="w-6 h-6" />
                </div>
                <div>
                  <p className="text-emerald-400 font-bold text-lg mb-2">{success}</p>
                  <p className="text-emerald-400/60 text-sm">Redirecting to login in 5 seconds...</p>
                </div>
                <Link to="/login" className="px-6 py-2 bg-emerald-500 text-white rounded-lg font-black uppercase tracking-widest text-[10px] hover:bg-emerald-400 transition-colors">
                   Login Now
                </Link>
              </motion.div>
            )}
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full bg-[#111] border border-[#222] focus:border-indigo-500/50 text-white pl-12 pr-4 py-3.5 rounded-xl outline-none transition-all shadow-inner placeholder:text-[#333] font-medium"
